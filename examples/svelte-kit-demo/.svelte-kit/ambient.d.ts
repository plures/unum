...
declare module '$env/static/private' {
	...
	export const EFC_13828: string;
	export const ESPMRepoRoot: string;
	export const FPS_BROWSER_APP_PROFILE_STRING: string;
	export const FPS_BROWSER_USER_PROFILE_STRING: string;
	export const GIT_ASKPASS: string;
	export const GIT_LFS_PATH: string;
	export const GIT_TR2_CONFIG_PARAMS: string;
	export const GIT_TR2_EVENT: string;
	export const GIT_TRACE2_CONFIG_PARAMS: string;
	export const GIT_TRACE2_EVENT: string;
	...
	export const LocalVpack: string;
	...
	export const NUGET_CREDENTIALPROVIDER_MSAL_ENABLED: string;
...
declare module '$env/dynamic/private' {
	export const env: {
		...
		GIT_ASKPASS: string;
		GIT_LFS_PATH: string;
		GIT_TR2_CONFIG_PARAMS: string;
		GIT_TR2_EVENT: string;
		GIT_TRACE2_CONFIG_PARAMS: string;
		GIT_TRACE2_EVENT: string;
		GOPATH: string;
		HOME: string;
		HOMEDRIVE: string;
		HOMEPATH: string;
		...
		NUGET_CREDENTIALPROVIDER_MSAL_ENABLED: string;
